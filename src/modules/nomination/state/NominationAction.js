...
export function getNominationPayments(customProps) {
  return function(dispatch) {
    const response = axios
      .get(`${API_BASE_URL}/nominations/${customProps}/payments`)
      .then(response => {
...
export function getNominationCandidates(customProps) {
  return function(dispatch) {
    const response = axios
      .get(`${API_BASE_URL}/nominations/${customProps}/candidates`)
      .then(response => {
        const getNominationCandidates = response.data;
        dispatch(nominationCandidateLoaded(getNominationCandidates));
      })
      .catch(err => {
...
export function postNominationPayments(candidatePayments) {
  return function(dispatch) {
    ...
    const response = axios
      .post(`${API_BASE_URL}/nominations/payments`, { ...nominationPayments })
      .then(response => {
...
export function updateNominationPayments(customProps, candidatePayments) {
  return function(dispatch) {
    ...
    const response = axios
      .put(`${API_BASE_URL}/nominations/${customProps}/payments`, {
        ...nominationPayments
      })
      .then(response => {
        const getNominationPayments = response.data;
